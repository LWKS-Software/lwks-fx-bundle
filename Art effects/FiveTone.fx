...
/**
 ...
 Lightworks two tone and tri-tone effects, there's just more of them.
   ...
   * Threshold Two:  The next level up.  Video under this will get the mid dark colour.
   * Threshold Three:  Mid level.  Video below will get the mid colour, above the mid
     light colour.
   * Threshold Four:  Level below peak white.  Video above it gets the light colour.
...
DeclareFloatParam (Threshold1, "Threshold One",   kNoGroup, kNoFlags, 0.2, 0.0, 1.0);
DeclareFloatParam (Threshold2, "Threshold Two",   kNoGroup, kNoFlags, 0.4, 0.0, 1.0);
DeclareFloatParam (Threshold3, "Threshold Three", kNoGroup, kNoFlags, 0.6, 0.0, 1.0);
DeclareFloatParam (Threshold4, "Threshold Four",  kNoGroup, kNoFlags, 0.8, 0.0, 1.0);
...
DeclareColourParam (MidColour,   "Mid Dark Colour",  kNoGroup, kNoFlags, 0.2, 0.2, 0.2, 1.0);
DeclareColourParam (MidColour2,  "Mid Colour",       kNoGroup, kNoFlags, 0.5, 0.5, 0.5, 1.0);
DeclareColourParam (MidColour3,  "Mid Light Colour", kNoGroup, kNoFlags, 0.8, 0.8, 0.8, 1.0);
