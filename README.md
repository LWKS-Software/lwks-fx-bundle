# Lightworks user Fx library, September 22, 2026.
...
|Colour repair                 |ColourRepair.fx         |Repairs minor colour blemishes.                                               |
...
|Pixel                         |Pixel.fx                |Pixel interpolation is off, resolution is scaled to the sequence resolution   |
...
|Text inversion                |TextInversion.fx        |The text video in Fg is optionally replaced with negative background          |
...
|Framed blend                  |FramedBlend.fx          |Blending with framing adjustment and masking                                  |
...
|3D Doorway                   |Yes      |No       |3D Doorway.fx           |Multi-mode transition 2D split or 3D rigid swing       |
...
|Fade to black                |Yes      |No       |Fade.fx                 |Fades a single video stream out or in to/from black    |
