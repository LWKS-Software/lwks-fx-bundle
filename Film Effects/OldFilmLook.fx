...
/**
 ...
 flicker.
   ...
   [*]Frame zoom: Adjusts the frame size. Necessary to show the film sprockets at the edges.
   [*]Sprockets
      [*]Size: Sets the sprocket hole size.
      [*]Alignment: Adjusts the sprocket hole alignment.
      [*]Double quantity: Enables single or double sprockets.
   [*]Flaws
      [*]Grain: Applies the amount of grain needed.
      [*]Scratches: Adds scratches to the film.
      [*]Dirt: Adds film dirt.
   [*]Jitter
      [*]Minor: Sets the small jitter amount.
      [*]Major: Sets the large jitter amount.
      [*]Rotational: Sets the amount of rotational jitter.
   [*]Flicker strength: Adds exposure and chemistry-based flicker.
...
// Changed "Grain Strength" to "Grain".
// Changed "Scratch Amount" to "Scratches".
// Changed "Dirt Amount" to "Dirt".
//
...
DeclareFloatParam (gstrength,              "Grain",            "Flaws",     kNoFlags, 1.0, 0.0, 2.0);
DeclareFloatParam (ScratchAmount,          "Scratches",        "Flaws",     kNoFlags, 0.5, 0.0, 1.0);
DeclareFloatParam (NoiseAmount,            "Dirt",             "Flaws",     kNoFlags, 0.5, 0.0, 1.0);
