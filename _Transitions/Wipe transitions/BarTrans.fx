...
/**
 ...
 then blows those apart either horizontally or vertically.
   ...
   [*]Transition direction:  Switches the transition direction between vertical
      and horizontal.
   [*]Bar width:  Self explanatory.
   [*]Blend settings
...
DeclareEntryPoint (Bars_H)
{
   ...
   if (ShowKey) { return ShowAlpha (Fg_H, uv3); }
...
DeclareEntryPoint (Bars_V)
{
   ...
   if (ShowKey) { return ShowAlpha (Fg_V, uv3); }
...
dded checkerboard alpha display to show key.
//
// Updated 2026-07-16 jwrl.
// Revised for compatability with LW versions 2026 and higher.
//
