...
/**
 ...
 analogue cameras and TVs produced.
   ...
   [*]R-B offset X:  Adjusts the horizontal red-blue error.
   [*]R-B offset Y:  Adjusts the vertical red-blue error.
...
// Changed "R-B displacement" to "R-B offset".
//
...
DeclareFloatParam (Xdisplace, "R-B offset", kNoGroup, "SpecifiesPointX|DisplayAsPercentage", 0.0, -0.05, 0.05);
DeclareFloatParam (Ydisplace, "R-B offset", kNoGroup, "SpecifiesPointY|DisplayAsPercentage", 0.0, -0.05, 0.05);
